                    ...
                    <body>
                        <div style="display:flex; justify-content: center; " >
                            ...
                            ">
                                ...
                                <div id="counter" style="text-align: left; color:black;font-family:'Source Sans Pro',sans-serif;font-weight: bold; font-size: 116px; opacity: 0.5;
                                ...
                                <div>
                                    ...
                                    <div style="text-align:left; color: black; font-size: 36px; font-family:  'Roboto Medium',sans-serif; font-weight: 300; line-height: 24px; word-wrap: break-word">Αριθμός Συμμετεχόντων</div>
                                </div>
                            </div>
                        </div>
