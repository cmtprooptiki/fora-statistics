...
# Create a container with custom CSS to increase the height
    ...
    with st.container():
            ...
            with col01:
                st.markdown("""<h3 style="text-align:center; font-size:25px"><span>Έρευνα που αφορά τις Προκλήσεις στην</span> <br>
    ...
    with st.container():
        ...
        with col1:
            ...
            st.markdown("""<iframe width="560" height="315" src="https://healthcare-management.gr/wp-content/uploads/2023/10/ds.mp4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen> allow=”autoplay”</iframe>
 """,unsafe_allow_html=True)
...
.configure_axis(
    ...
    st.markdown("<h3>Τα ευρήματα που παρουσιάζονται στην παρούσα ανάλυση της έρευνας βασίζονται αποκλειστικά στις απαντήσεις που ελήφθησαν από τους συμμετέχοντες που συμπλήρωσαν τα ερωτηματολόγια. Τα αποτελέσματα αυτά περιορίζονται από παράγοντες, όπως το μέγεθος του δείγματος, η μεροληψία των απαντήσεων και οι ελλιπείς απαντήσεις. Για μια πληρέστερη και ακριβέστερη κατανόηση της τρέχουσας κατάστασης, ενδέχεται να απαιτούνται πρόσθετες πηγές δεδομένων και συνεχής παρακολούθηση.</h3>",unsafe_allow_html=True)
